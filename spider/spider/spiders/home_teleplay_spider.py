...
import re
class home_teleplay_spider(scrapy.Spider):

    name = "home_teleplay_spider"
    ...
    def __init__(self, **kwargs):
        super(home_teleplay_spider, self).__init__(**kwargs)
        print "启动爬虫"
    ...
    def parse(self, response):
        music_ul = response.xpath(
            "//div[@id='b_teleplay']//ul[@class='vidbox v-list']//li"
        )
        for sel in music_ul:
            item = HomeItem()
